...
ACM sigconf paper template with modular section layout, reusable package configs, and revision markup support. Ships with [CCS 2026](https://www.sigsac.org/ccs/CCS2026/) metadata as default — update `main.tex` for your target venue.
...
```
main.tex                  # Entry point (ACM sigconf, default: CCS 2026)
